...
public abstract class ProxyAutoMobile implements Serializable {
	...
	private String dbName = "JSPHDEV_Auto1";

	private String username = "JSPHDEV";
	private String password = "JSPHDEV";
	...
	public void buildAuto(String modelName, String fileName){
		...
		createAutoDB(auto_shop.get(modelName));
	}
	
	public void deleteAuto(String modelName){
		auto_shop.remove(modelName);
